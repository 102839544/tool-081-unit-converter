...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 单位转换工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "unit-converter".lower() or "clock" in "unit-converter".lower():
            self.setup_timer_ui(main)
        elif "random" in "unit-converter".lower() or "dice" in "unit-converter".lower() or "coin" in "unit-converter".lower():
            self.setup_random_ui(main)
        elif "note" in "unit-converter".lower() or "todo" in "unit-converter".lower():
    ...
    def generate_random(self):
        if "dice" in "unit-converter".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "unit-converter".lower():
